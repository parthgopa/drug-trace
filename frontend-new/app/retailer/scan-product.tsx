...
export default function RetailerScanScreen() {
  ...
  const handleSubmitScan = async () => {
    ...
    setScanning(true);
    try {
      const response = await supplyChainAPI.retailerScan({
      ...
      if (response.success) {
        Alert.alert(
          'Success',
          `Product verified and received!\nTotal scans: ${response.journey?.total_scans || 1}\nCurrent location: ${response.journey?.current_location || 'Your store'}`,
          [
            {
              text: 'Scan Another',
              onPress: () => {
      ...
      <View style={styles.container}>
        <View style={styles.permissionContainer}>
          ...
          <Text style={styles.permissionText}>
            We need camera access to scan and verify product QR codes
          </Text>
          <CustomButton
        ...
        <View style={styles.overlay}>
          ...
          <View style={styles.bottomOverlay}>
            <View style={styles.roleIndicator}>
              <Ionicons name="storefront-outline" size={24} color={theme.colors.info} />
              <Text style={styles.roleText}>Retailer Scan</Text>
            </View>
            <Text style={styles.instructionText}>
              {scanning ? 'Processing...' : 'Scan product to verify receipt'}
            </Text>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.locationSection}>
            ...
            <CustomInput
              ...
              multiline
              numberOfLines={2}
              placeholder="Enter store address manually if needed"
            />
          </View>
          ...
          <CustomInput
            ...
            multiline
            numberOfLines={3}
            placeholder="Add notes about product condition, packaging, etc..."
          />

          <View style={styles.infoCard}>
            <Ionicons name="information-circle-outline" size={20} color={theme.colors.info} />
            <Text style={styles.infoText}>
              This scan will record the product's arrival at your retail location in the supply chain.
            </Text>
          </View>
