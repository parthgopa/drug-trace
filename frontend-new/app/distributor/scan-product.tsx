...
export default function DistributorScanScreen() {
  ...
  const handleSubmitScan = async () => {
    ...
    setScanning(true);
    try {
      const response = await supplyChainAPI.distributorScan({
      ...
      if (response.success) {
        Alert.alert(
          'Success',
          `Product tracked successfully!\nTotal scans in journey: ${response.journey?.total_scans || 1}`,
          [
            {
              text: 'Scan Another',
              onPress: () => {
        ...
        <View style={styles.overlay}>
          ...
          <View style={styles.bottomOverlay}>
            <View style={styles.roleIndicator}>
              <Ionicons name="car-outline" size={24} color={theme.colors.secondary} />
              <Text style={styles.roleText}>Distributor Scan</Text>
            </View>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.form}>
          ...
          <CustomInput
            ...
            multiline
            numberOfLines={3}
            placeholder="Add notes about product condition, storage, etc..."
          />
